 ...
 * 
 * Integra com EmailJS para envio de cadastros de newsletter
 * e exibe ícones das redes sociais da empresa.
 */
 ...
 * Cada item contém o path SVG e metadados para renderização.
 */
const SOCIAL_ICONS = [
  {
    name: "Facebook",
...
export const Contact: React.FC = () => {
  ...
  // Inicializa EmailJS com chave pública do ambiente
  useEffect(() => {
   ...
   * Valida email, envia via EmailJS e exibe feedback.
   */
