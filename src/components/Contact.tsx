/**
 * @fileoverview Seção de contato com newsletter e links sociais.
 */
...
export const Contact: React.FC = () => {
  ...
  const handleNewsletterSubmit = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      await emailjs.send(
        ...
        import.meta.env.VITE_EMAILJS_TEMPLATE_ID,
        {
          ...
          message: `Novo cadastro de newsletter: ${emailInput}`,
          reply_to: emailInput,
        }
      );
    ...
    <section id="contact" className="bg-background">
      <div className="section-container">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 mb-12">
            <Input
              type="email"
      ...
      {SOCIAL_NETWORKS.map((network) => (
        ...
        >
          <svg
            ...
            aria-hidden="true"
          >
            <path d={network.svgPath} fill="currentColor" />
          </svg>
        </a>
      ))}
    </div>
